...
[Activity(Label = "InteractiveStereoKitDemoActivity", MainLauncher = false, Exported = true)]
...
public class InteractiveStereoKitDemoActivity : Activity, ISurfaceHolderCallback2 //problem with making anything else the callback is that only the Activity already implements most of the interface methods
{
    //NOTE: Theoretically, if you wanted to push/pop pages like a NavigationController, you would make this a stack
    InteractiveStereoKitDemoPage currentPage;
    ...
    {
        Console.WriteLine($"--------------------InteractiveStereoKitDemoActivity OnCreate");
        base.OnCreate(savedInstanceState);

        //NOTE: This gets rid of the bar on top that tells you the name of the app
        this.RequestWindowFeature(WindowFeatures.NoTitle);

        AndroidResourceIDsRuntime.interactiveStereokitDemoPageResID = Resources.GetIdentifier("interactivestereokitdemo_page", "layout", "com.nakamir.skarcore");
        currentPage = new InteractiveStereoKitDemoPage(this);
        currentPage.OpenPage(AndroidResourceIDsRuntime.interactiveStereokitDemoPageResID);
    }
    ...
    public void SurfaceChanged(ISurfaceHolder holder, [GeneratedEnum] Format format, int width, int height)
    {
        ...
        if (currentPage != null)
        {
            (currentPage).SetSKWindowSize(width, height);
        }
    }
    ...
    protected override void OnRestart()
    {
        ...
        Console.WriteLine($"--------------------InteractiveStereoKitDemoActivity OnRestart");
